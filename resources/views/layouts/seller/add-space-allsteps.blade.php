                        ...
                        <div id="step-11" class="border">
                            <div style="text-align:center;">
                                 <h2 >Step 2 of 9</h2>
                                    ...
                                    <p>Enter the type of space that most closely represents the physical space being listed. Learn more</p></div>
                                   <p style="margin-left:25rem;"> <img src="{{ asset('assets/images/users/spaces/6700.png') }}" alt="img">Examples: 'Apartment' 'Photo Studio' 'Restaurant'</p>
                                   <input style="width:980px;margin-left:25rem;" type="text" class="form-control rounded-0" id="inputtext" placeholder="Gallery for art">
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="exampleInputPassword9" placeholder="">
                                </div>
