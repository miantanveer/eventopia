                    ...
                    <div class="main-container container-fluid fullpage">
                        <div style="display:flex;flex-direction:row;justify-content:space-between;" class="account mt-5 mb-2">
                            <div>
                                ...
                                <span class="avatar avatar-xl brround cover-image" data-bs-image-src="{{ asset('assets/images/users/spaces/pro.png') }}" style="height:100px;width:100px;margin-left:20px;background: url(&quot;http://sash.pk/assets/images/users/6.jpg&quot;) center center;">
                                                        <span style="height:25px;width:25px;" class="badge rounded-pill avatar-icons bg-green"><i class="fe fe-camera fs-12"></i></span>
                                                    </span>
                                
                            </div>
                           <div >
                            <button style="border-color:black;" type="button" class="btn btn-outline-default pull-right"><strong>View Profile</strong></button></div>
                        </div>
                        <!-- FORM -->
                        <div class="card-body">
                            <div class="row mt-5 mb-3">
                                ...
                                <div class="d-flex align-items-center input-container">
                                    <input type="email" class="form-control border border-default rounded-0" value=""
                                         required
                        ...
                        <div class="notify mt-2 mb-6">
                            ...
                            <p>Send me exclusive deals, inspiration, news, and community updates via email.</p>
                        </div>
