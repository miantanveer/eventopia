                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group mt-4 ms-3 me-3">
                                    <select name="lisitng" class="form-control text-white form-select select2" data-bs-placeholder="Select listing">
                            ...
                            <div class="offset-md-4 col-5">
                                <div class="form-group mt-4 text-md-end">
                                    ...
                                    <a class="modal-effect btn bg-white" data-bs-effect="effect-scale" data-bs-toggle="modal" href="#blockTimeModal">Block Time</a>
                                </div>
                            </div>
                        </div>
                    </div>
