            ...
            <li>
                ...
                <div class="notification-body">
                    <div class="media mt-0">
                        ...
                        <div class="media-body ms-3 d-flex">
                            <div class="">
                                <p class="fs-15 text-dark fw-bold mb-0">Elida Distefa<span
                                        class="badge bg-success ms-3 px-2 pb-1 mb-1">New Deal</span></p>
            ...
            <li>
                ...
                <div class="notification-body">
                    <div class="media mt-0">
                        ...
                        <div class="media-body ms-3 d-flex">
                            <div class="">
                                <p class="fs-15 text-dark fw-bold mb-0">Mercy Ritia<span
                                        class="badge bg-danger ms-3 px-2 pb-1 mb-1">Last Deal</span></p>
                                <p class="mb-0 fs-13 text-dark">Created New Template for Designing Department.</p>
                            </div>
                            <div class="notify-time">
