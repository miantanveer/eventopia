                ...
                <div class="app-sidebar bg-primary">
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#"><img class="me-2" src="{{asset('assets/images/icons/list-space.png')}}" alt=""><span class="side-menu__label text-white"> List a Space</span></a>
                            </li>
                            <li class="slide">
