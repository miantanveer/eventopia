...
<div class="app-header header sticky">
    <div class="container-fluid main-container">
        <div class="d-flex">
            <a aria-label="Hide Sidebar" class="app-sidebar__toggle text-dark" data-bs-toggle="sidebar"
                                        ...
                                        @foreach (@$notifies as $notify)
                                            @if (@$notify->type == 'service')
                                                <a class="dropdown-item d-flex"
                                                    href="{{ route('pending-quote-requests') }}">
                                                    ...
                                                    <div class="mt-1">
                                                        ...
                                                        <span
                                                            class="notification-subtext">{{ lang(@$notify->created_at->diffForHumans()) }}</span>
                                                    </div>
                                                </a>
                                            @else
                                                <a class="dropdown-item d-flex">
