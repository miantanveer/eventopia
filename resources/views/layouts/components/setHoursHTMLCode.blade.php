                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <select name="monday_start_time_0"
                                    ...
                                    <option value="6 AM" class="option">6 AM</option>
                                    <option value="7 AM" class="option">7 AM</option>
                                    ...
                                    <option value="1 AM" class="option">1 AM</option>
                                    <option value="2 AM" class="option">2 AM</option>
                                    <option value="3 AM" class="option">3 AM</option>
                                    <option value="4 AM" class="option">4 AM</option>
                                    <option value="5 AM" class="option">5 AM</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 row-content-3 hide-on-switch" style="display: none">
                    <div class="form-group">
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="wednesday_radio" value="0"
                                    id="time-radio-3" {{@$time->wednesday == 0 ? 'checked' : ''}}>
                                <span class="custom-control-label">6:00 AM - 12:00 AM</span>
                            </label>
                            <label class="custom-control custom-radio">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        <label class="custom-switch form-switch me-5">
                            <input type="checkbox" name="thursday" id="custom-switch-checkbox4"
                                class="custom-switch-input" value="thursday" {{ @$time->thursday == 'thursday' ?
                            'checked' : '' }}>
                            <span class="custom-switch-indicator custom-switch-indicator-md"></span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 row-content-4 hide-on-switch" style="display: none">
                    <div class="form-group">
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="thursday_radio" value="0"
                                    id="time-radio-4" {{@$time->thursday_radio == 0 ? 'checked' : ''}}>
                                <span class="custom-control-label">6:00 AM - 12:00 AM</span>
                            </label>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 row-content-5 hide-on-switch" style="display: none">
                    <div class="form-group">
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="friday_radio" value="0"
                                    id="time-radio-5" {{@$time->friday_radio == 0 ? 'checked' : ''}}>
                                <span class="custom-control-label">6:00 AM - 12:00 AM</span>
                            </label>
                            <label class="custom-control custom-radio">
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        <label class="custom-switch form-switch me-5">
                            <input type="checkbox" name="saturday" id="custom-switch-checkbox6"
                                class="custom-switch-input" value="saturday" {{ @$time->saturday == 'saturday' ?
                            'checked' : '' }}>
                            <span class="custom-switch-indicator custom-switch-indicator-md"></span>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 row-content-6 hide-on-switch" style="display: none">
                    <div class="form-group">
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="saturday_radio" value="0"
                                    id="time-radio-6" {{@$time->saturday_radio == 0 ? 'checked' : ''}}>
                                <span class="custom-control-label">6:00 AM - 12:00
                                    AM</span>
                            </label>
                            <label class="custom-control custom-radio">
                ...
                <div class="col-lg-5 col-md-4 col-sm-6 mt-2 select-content-6">
                    ...
                    <div class="ps-0" id="Add-Hours-6">
                        <a class="btn btn-white addMore-6 text-dark">{{lang('Add hours')}}</a>
                    </div>
                </div>
            </div>
        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 row-content-7 hide-on-switch" style="display: none">
                    <div class="form-group">
                        <div class="custom-controls-stacked">
                            <label class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="sunday_radio" value="0"
                                    id="time-radio-7" {{@$time->sunday_radio == 0 ? 'checked' : ''}}>
                                <span class="custom-control-label">6:00 AM - 12:00
                                    AM</span>
                            </label>
                            <label class="custom-control custom-radio">
