                    ...
                    <div class="col-lg-6 dialog" id="dialog">
                        ...
                        <div class="form-container mt-sm-7 me-sm-6" align="center">
                            ...
                            <select name="start-time" class="Select_Time form-select mb-5" id="start_time" disabled>
                                <option value="6 AM">6:00 {{ lang('AM') }}</option>
                                <option value="7 AM">7:00 {{ lang('AM') }}</option>
                                <option value="8 AM">8:00 {{ lang('AM') }}</option>
                                <option value="9 AM">9:00 {{ lang('AM') }}</option>
                                <option value="10 AM">10:00 {{ lang('AM') }}</option>
                                <option value="11 AM">11:00 {{ lang('AM') }}</option>
                                <option value="12 PM">12:00 {{ lang('PM') }}</option>
                                <option value="1 PM">1:00 {{ lang('PM') }}</option>
                                <option value="2 PM">2:00 {{ lang('PM') }}</option>
                                <option value="3 PM">3:00 {{ lang('PM') }}</option>
                                <option value="4 PM">4:00 {{ lang('PM') }}</option>
                                <option value="5 PM">5:00 {{ lang('PM') }}</option>
                                <option value="6 PM">6:00 {{ lang('PM') }}</option>
                                <option value="7 PM">7:00 {{ lang('PM') }}</option>
                                <option value="8 PM">8:00 {{ lang('PM') }}</option>
                                <option value="9 PM">9:00 {{ lang('PM') }}</option>
                                <option value="10 PM">10:00 {{ lang('PM') }}</option>
                                <option value="10 PM">11:00 {{ lang('PM') }}</option>
                            </select>
                            ...
                            <button type="button" class="clear_button-1 float-start mb-5 mb-lg-0 ms-md-9 mt-lg-6" id="clear-button">{{
                                lang('Clear') }}</button>
                            <button type="button" class="clear_button-2 me-md-9 mb-5 mb-lg-0 float-end mt-lg-6" onclick="search_spaces()">{{
                                lang('Save') }}</button>
                        </div>
                    </div>
                </div>
