                    ...
                    @foreach ($langs as $lang)
                        <li class="col-lg-6 mb-2">
                            <a href="{{ route('local', $lang->code) }}"
                                ...
                                <span class="country-selector"><img alt="" src="{{ asset($lang->image) }}" class="me-3 language"></span>
                                {{ $lang->name }}
                            </a>
                        </li>
                    @endforeach
        ...
        <div class="modal-content country-select-modal">
            <div class="modal-header">
                <h1 style="text-align:center;color:#000017" class="modal-title">
                    {{ lang("Create an account to list
                                        your space") }}</h1><button
            ...
            <div class="modal-footer mt-0 mb-5">
                <p style="height:39px;width:490px;color:#313131;text-align:center;">
                    <b>{{ lang("Eventopia will send you
                ...
                <label style="height:771;width:600;margin-right:50px;"
                    ...
                    <span
                        class="custom-control-label">{{ lang("I don't want to receive marketing emails from
                                                Eventopia.") }}</span>
                </label>
                <div>
                    <h6 style="height:17;width:216;margin-right:142px;">
                        <b>{{ lang('Already have an account? ') }}<span
            ...
            <div class="modal-header">
                <h1 style="text-align:center;color:#000017" class="modal-title">
                    {{ lang("Create an account to book
                                        a space") }}</h1><button aria-label="Close"
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <a style="height:46px;width:510;background-color:#003B95;color:#FFFFFF"
                                    ...
                                    id="exampleInputPassword1">{{ lang("Sign
                                                                        up") }}</a><br>
                                <p style="height:39px;width:460px;color:#6B6B6B;padding-right:50px;text-align:center">
                                    {{ lang('By clicking Sign up, you agree to') }} <span
                                        style="text-decoration:underline;">{{ lang("Eventopia
