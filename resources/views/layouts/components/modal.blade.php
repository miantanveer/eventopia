...
<div class="modal fade" id="my-modal">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content country-select-modal">
            <div class="modal-header">
                <h1 style="text-align:center;color:#000017" class="modal-title">{{lang("Create an account to list
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <a style="height:46px;width:510;background-color:#003B95;color:#FFFFFF" type="password"
                                    class="form-control btn btn-info rounded-0" href="#" id="exampleInputPassword1">{{lang("Sign
                                    up")}}</a><br>
                                <p style="height:39px;width:460px;color:#6B6B6B;padding-right:50px;text-align:center">
                                    {{lang("By clicking Sign up, you agree to")}} <span style="text-decoration:underline;">{{lang("Eventopia
            ...
            <div class="modal-footer mt-0 mb-5">
                <p style="height:39px;width:490px;color:#313131;text-align:center;"> <b>{{lang("Eventopia will send you
                ...
                <div>
                    <h6 style="height:17;width:216;margin-right:142px;"><b>{{lang("Already have an account? ")}}<span
                                style="color:#006CE4">{{lang('Login')}}</span></b></h6>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="add-entertainment">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content country-select-modal">
            <div class="modal-header">
                <h2 class="modal-title text-center text-dark">{{lang("Create an account to list
...
<div class="modal fade" id="signup-modal">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content country-select-modal">
            <div class="modal-header">
                <h1 style="text-align:center;color:#000017" class="modal-title">{{lang("Create an account to book
