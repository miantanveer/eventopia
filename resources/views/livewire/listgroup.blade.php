        ...
        @section('content')
                                        ...
                                        <div class="">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    Cras justo odio
                                                    <span class="badgetext badge bg-default rounded-pill">20</span>
                                                </li>
                                                <li class="list-group-item">
                                                    Dapibus ac facilisis in
                                                    <span class=" badgetext badge bg-default rounded-pill">15</span>
                                                </li>
                                                <li class="list-group-item">
                                                    Morbi leo risus
                                                    <span class=" badgetext badge bg-default rounded-pill">10</span>
                                                </li>
                                                <li class="list-group-item">
                                                    Porta ac consectetur ac
                                                    <span class=" badgetext badge bg-default rounded-pill">8</span>
                                                </li>
                                                <li class="list-group-item">
                                                    Vestibulum at eros
                                                    <span class=" badgetext badge bg-default rounded-pill">1</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Paragraph with Unorder List</h3>
                                    </div>
                                    <div class="card-body px-5">
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of
                                            Lorem Ipsum, you need to as necessary All the Lorem Ipsum generators on the Internet tend to repeat Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and
                                            the like).</p>
                                        <ul class="list-style-1 mb-3">
                                            <li>Lorem ipsum dolor sit amet</li>
                                            <li>Consectetur adipiscing elit</li>
                                            <li>Integer molestie lorem at massa</li>
                                            <li>Facilisis in pretium nisl aliquet</li>
