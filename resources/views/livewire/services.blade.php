                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-10 col-lg-9">
                                            <div class="mt-1">
                                                ...
                                                <p class="mb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="progress progress-md mb-3 mb-md-0">
                                                    <div class="progress-bar bg-pink" style="width: 65%;">80%</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Android</label>
                                                <div class="progress progress-md mb-0">
                                                    <div class="progress-bar bg-success" style="width: 70%;">69%</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
