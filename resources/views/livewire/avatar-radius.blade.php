                                        ...
                                        <div class="text-wrap">
                                            ...
                                            <div class="example">
                                                <div class="avatar-list">
                                                    ...
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/2.jpg')}}"></span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/1.jpg')}}"></span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/2.jpg')}}"></span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/3.jpg')}}"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-wrap">
                                            ...
                                            <div class="example">
                                                <div class="avatar-list">
                                                    <span class="avatar avatar-md bradius cover-image" data-bs-image-src="{{asset('assets/images/users/21.jpg')}}">
                                                        <span class="badge rounded-pill avatar-badges bg-primary fs-10">3</span></span>
                                                    <span class="avatar avatar-md bradius cover-image" data-bs-image-src="{{asset('assets/images/users/5.jpg')}}">
                                                            <span class="badge rounded-pill avatar-badges bg-secondary fs-10">1</span>
                                                    </span>
                                                    <span class="avatar avatar-md bradius cover-image" data-bs-image-src="{{asset('assets/images/users/9.jpg')}}">
                                                        <span class="badge rounded-pill avatar-badges bg-red fs-10">4</span>
                                                    </span>
                                                    <span class="avatar avatar-md bradius cover-image" data-bs-image-src="{{asset('assets/images/users/6.jpg')}}">
                                                        <span class="badge rounded-pill avatar-badges bg-green fs-10">6</span>
                                                    </span>
                                                    <span class="avatar avatar-md bradius cover-image" data-bs-image-src="{{asset('assets/images/users/7.jpg')}}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-wrap">
                                            ...
                                            <div class="example">
                                                <div class="avatar-list">
                                                    <span class="avatar avatar-xl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/21.jpg')}}">
                                                        <span class="badge rounded-pill avatar-icons bg-primary"><i class="fe fe-edit fs-12"></i></span></span>
                                                    <span class="avatar avatar-xl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/5.jpg')}}">
                                                            <span class="badge rounded-pill avatar-icons bg-secondary"><i class="fe fe-arrow-down fs-12"></i></span>
                                                    </span>
                                                    <span class="avatar avatar-xl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/9.jpg')}}">
                                                        <span class="badge rounded-pill avatar-icons bg-red"><i class="fe fe-lock fs-12"></i></span>
                                                    </span>
                                                    <span class="avatar avatar-xl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/6.jpg')}}">
                                                        <span class="badge rounded-pill avatar-icons bg-green"><i class="fe fe-camera fs-12"></i></span>
                                                    </span>
                                                    <span class="avatar avatar-xl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/7.jpg')}}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-wrap">
                                            ...
                                            <div class="example">
                                                <div class="avatar-list">
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/21.jpg')}}"></span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/5.jpg')}}">
                                                            <span class="avatar-status bg-secondary"></span>
                                                    </span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/9.jpg')}}">
                                                            <span class="avatar-status bg-red"></span>
                                                    </span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/6.jpg')}}">
                                                            <span class="avatar-status bg-green"></span>
                                                    </span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/7.jpg')}}">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-wrap">
                                            ...
                                            <div class="example">
                                                <div class="avatar-list">
                                                    <span class="avatar avatar-sm bradius cover-image" data-bs-image-src="{{asset('assets/images/users/4.jpg')}}"></span>
                                                    <span class="avatar bradius cover-image" data-bs-image-src="{{asset('assets/images/users/3.jpg')}}"></span>
                                                    <span class="avatar avatar-md bradius cover-image" data-bs-image-src="{{asset('assets/images/users/5.jpg')}}"></span>
                                                    <span class="avatar avatar-lg bradius cover-image" data-bs-image-src="{{asset('assets/images/users/6.jpg')}}"></span>
                                                    <span class="avatar avatar-xl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/4.jpg')}}"></span>
                                                    <span class="avatar avatar-xxl bradius cover-image" data-bs-image-src="{{asset('assets/images/users/7.jpg')}}"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
