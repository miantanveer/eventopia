        ...
        <div class="card-body">
            <div class="row ">
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-primary-light d-grid mb-3" data-bs-effect="effect-scale"
                        data-bs-toggle="modal" href="#modaldemo8">Scale</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-secondary-light d-grid mb-3" data-bs-effect="effect-slide-in-right"
                        data-bs-toggle="modal" href="#modaldemo8">Slide In Right</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-danger-light d-grid mb-3" data-bs-effect="effect-slide-in-bottom"
                        data-bs-toggle="modal" href="#modaldemo8">Slide In Bottom</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-warning-light d-grid mb-3" data-bs-effect="effect-newspaper"
                ...
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-info-light d-grid mb-3" data-bs-effect="effect-flip-horizontal"
                ...
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-secondary-light d-grid mb-3" data-bs-effect="effect-super-scaled"
                        data-bs-toggle="modal" href="#modaldemo8">Super Scaled</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-danger-light d-grid mb-3" data-bs-effect="effect-sign"
                        data-bs-toggle="modal" href="#modaldemo8">Sign</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-warning-light d-grid mb-3" data-bs-effect="effect-rotate-bottom"
                        data-bs-toggle="modal" href="#modaldemo8">Rotate Bottom</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-success-light d-grid mb-3" data-bs-effect="effect-rotate-left"
                        data-bs-toggle="modal" href="#modaldemo8">Rotate Left</a>
                </div>
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <a class="modal-effect btn btn-info-light d-grid mb-3" data-bs-effect="effect-just-me"
        ...
        <div class="col-sm-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <p>Add <code class="highlighter-rouge">.modal-sm </code> or <code class="highlighter-rouge">.modal-lg
                        </code> or <code class="highlighter-rouge">.modal-xl </code> to modal-dialog to increase and
                        decrease the modal box
                        sizes.
                    </p>
                    <button class="btn btn-primary bg-primary-gradient mt-3" data-bs-toggle="modal"
                        data-bs-target="#smallmodal">Small Modal</button>
                    <button class="btn btn-success bg-success-gradient mt-3" data-bs-toggle="modal"
                        data-bs-target="#largemodal">large Modal</button>
                    <button class="btn btn-secondary bg-secondary-gradient mt-3" data-bs-toggle="modal"
                        data-bs-target="#extralargemodal">Extralarge Modal</button>
                    <button class="btn btn-danger bg-danger-gradient mt-3" data-bs-toggle="modal"
                        data-bs-target="#scrollingmodal">Scrolling Modal</button>
                    <button class="btn btn-warning bg-warning-gradient mt-3" data-bs-toggle="modal"
        ...
        <div class="col-lg-12">
            ...
            <div class="card" id="modal3">
                ...
                <div class="card-body">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-body text-center p-4 pb-5">
                                        ...
                                        <p class="mb-4 mx-4">There are many variations of passages of Lorem Ipsum
                                            available, but the majority have suffered alteration.</p><button
                                            class="btn btn-success pd-x-25">Continue</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- modal-wrapper-demo -->
                    <div class="text-center py-4 bg-light border">
                        <a class="btn btn-primary" data-bs-target="#modaldemo4" data-bs-toggle="modal"
                            href="">View Live Demo</a>
                    </div>
                    <!-- modal-footer-demo -->
                </div>
            ...
            <div class="card" id="modal4">
                ...
                <div class="card-body">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-body text-center p-4 pb-5">
                                        ...
                                        <p class="mb-4 mx-4">There are many variations of passages of Lorem Ipsum
                                            available, but the majority have suffered alteration.</p><button
                                            aria-label="Close" class="btn btn-danger pd-x-25">Continue</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- modal-wrapper-demo -->
                    <div class="text-center py-4 bg-light border">
                        <a class="btn btn-primary" data-bs-target="#modaldemo5" data-bs-toggle="modal"
                            href="">View Live Demo</a>
                    </div>
                    <!-- modal-footer-demo -->
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and
                        ...
                        to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is
                        ...
                        owing to the claims of duty or
