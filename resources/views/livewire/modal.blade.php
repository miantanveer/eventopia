                            ...
                            <div class="card" id="modal5">
                                ...
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-xl-3">
                                            <a class="modal-effect btn btn-info-light d-grid mb-3" data-bs-effect="effect-just-me" data-bs-toggle="modal" href="#modaldemo8">Just Me</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <button class="btn btn-primary bg-primary-gradient mt-3" data-bs-toggle="modal" data-bs-target="#smallmodal">Small Modal</button>
                                            <button class="btn btn-success bg-success-gradient mt-3" data-bs-toggle="modal" data-bs-target="#largemodal">large Modal</button>
                                            <button class="btn btn-secondary bg-secondary-gradient mt-3" data-bs-toggle="modal" data-bs-target="#extralargemodal">Extralarge Modal</button>
                                            <button class="btn btn-danger bg-danger-gradient mt-3" data-bs-toggle="modal" data-bs-target="#scrollingmodal">Scrolling Modal</button>
                                            <button class="btn btn-warning bg-warning-gradient mt-3" data-bs-toggle="modal" data-bs-target="#fullscreenmodal">Fullscreen Modal</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
