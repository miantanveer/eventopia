                                            ...
                                            <div class="container">
                                                <div class="row align-items-center flex-row-reverse">
                                                    <div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
                                                        Copyright © 2021 <a href="javascript:void(0)">Sash</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> Spruko </a> All rights reserved.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="footer border-top-0 footer-1">
                                            <div class="container">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
                                                        Copyright © 2021 <a href="javascript:void(0)">Sash</a>. Designed with by <a href="javascript:void(0)">Spruko</a> All rights reserved.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <footer class="main-footer ps-0 pe-0">
                                                <div class="row">
                                                    <div class="col-xl-8 col-lg-12 col-md-12 footer1">Copyright © 2021 <a href="javascript:void(0)">Sash</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> Spruko </a>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="top-footer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        <h6>Posts</h6>
                                                        <img alt="" src="{{asset('assets/images/media/media1.jpg')}}">
                                                        <img alt="" src="{{asset('assets/images/media/media2.jpg')}}">
                                                        <img alt="" src="{{asset('assets/images/media/media3.jpg')}}">
                                                        <img alt="" src="{{asset('assets/images/media/media4.jpg')}}">
                                                        <hr>
