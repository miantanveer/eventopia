                                ...
                                <div class="row">
                                    <div class="col-xl-3">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div>
                                                    <h5>Biography<i class="fe fe-edit-3 text-primary ms-2"></i></h5>
                                    ...
                                    <div class="col-xl-6">
                                                ...
                                                <div class="d-flex">
                                                    <div class="media mt-0">
                                                        <div class="media-user me-2">
                                                            <div class=""><img alt="" class="rounded-circle avatar avatar-md" src="{{asset('assets/images/users/16.jpg')}}"></div>
                                                        </div>
                                                        <div class="media-body">
                                        ...
                                        <div class="card border p-0 shadow-none">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    <div class="d-flex">
                                                        <img src="{{asset('assets/images/media/22.jpg')}}" alt="img" class="w-40 m-1 br-5">
                                                        <img src="{{asset('assets/images/media/24.jpg')}}" alt="img" class="w-40 m-1 br-5">
                                                    </div>
                                                    <h4 class="fw-semibold mt-3">There is nothing more beautiful.</h4>
                                                    <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                                    </p>
                                        ...
                                        <div class="card border p-0 shadow-none">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4">
                                                    <div class="d-flex">
                                                        <img src="{{asset('assets/images/media/26.jpg')}}" alt="img" class="w-30 m-1 br-5">
                                                        <img src="{{asset('assets/images/media/23.jpg')}}" alt="img" class="w-30 m-1 br-5">
                                                        <img src="{{asset('assets/images/media/21.jpg')}}" alt="img" class="w-30 m-1 br-5">
                                                    </div>
                                                    <h4 class="fw-semibold mt-3">There is nothing more beautiful.</h4>
                                                    <p class="mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                                    </p>
                                            ...
                                            <div class="card-body">
                                                <div class="">
                                                    <div class="media overflow-visible">
                                                        <img class="avatar brround avatar-md me-3" src="{{asset('assets/images/users/18.jpg')}}" alt="avatar-img">
                                                    ...
                                                    <div class="media overflow-visible mt-5">
                                                    ...
                                                    <div class="media overflow-visible mt-5">
                                                        <img class="avatar brround avatar-md me-3" src="{{asset('assets/images/users/2.jpg')}}" alt="avatar-img">
                                                        <div class="media-body valign-middle mt-0">
