                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="eamil-body mt-5">
                                            ...
                                            <div class="email-attch">
                                                <p class="font-weight-semibold">3 Attachments <a href="{{url('filemanager-details')}}">View</a></p>
                                            </div>
                                            <div class="row attachments-doc">
                                                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2 mb-sm-0">
                                                    <div class="border overflow-hidden p-0 br-7">
                                                        <a href="{{url('filemanager-details')}}"><img src="{{asset('assets/images/media/8.jpg')}}" class="card-img-top" alt="img"></a>
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2 mb-sm-0">
                                                    <div class="border overflow-hidden p-0 br-7">
                                                        <a href="{{url('filemanager-details')}}"><img src="{{asset('assets/images/media/22.jpg')}}" class="card-img-top" alt="img"></a>
                                                        <div class="p-3 text-center">
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2 mb-sm-0">
                                                    <div class="border overflow-hidden p-0 br-7">
                                                        <a href="{{url('filemanager-details')}}"><img src="{{asset('assets/images/media/6.jpg')}}" class="card-img-top" alt="img"></a>
                                                        <div class="p-3 text-center">
