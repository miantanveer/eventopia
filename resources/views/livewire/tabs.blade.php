        ...
        @section('content')
                    ...
                    <div class="row">
                                        ...
                                        <div class="tab-menu-heading">
                                            <div class="tabs-menu">
                                                ...
                                                <ul class="nav panel-tabs">
                                                    <li><a href="#tab1" class="active" data-bs-toggle="tab">Tab 1</a></li>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class=" tab-menu-heading">
                                            <div class="tabs-menu1">
                                                <!-- Tabs -->
                                                <ul class="nav panel-tabs">
                                                    <li><a href="#tab5" class="active" data-bs-toggle="tab">Tab 1</a></li>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="tab-menu-heading tab-menu-heading-boxed">
                                            <div class="tabs-menu-boxed">
                                                <!-- Tabs -->
                                                <ul class="nav panel-tabs">
                                                    <li><a href="#tab25" class="active" data-bs-toggle="tab">Tab 1</a></li>
                                                    <li><a href="#tab26" data-bs-toggle="tab">Tab 2</a></li>
                                                    <li><a href="#tab27" data-bs-toggle="tab">Tab 3</a></li>
                                                    <li><a href="#tab28" data-bs-toggle="tab">Tab 4</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="panel-body tabs-menu-body">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="tab-menu-heading tab-menu-heading-boxed">
                                            <div class="tabs-menu tabs-menu-border">
                                                <!-- Tabs -->
                                                <ul class="nav panel-tabs">
                                                    <li><a href="#tab29" class="active" data-bs-toggle="tab">Tab 1</a></li>
                                                    <li><a href="#tab30" data-bs-toggle="tab">Tab 2</a></li>
                                                    <li><a href="#tab31" data-bs-toggle="tab">Tab 3</a></li>
                                                    <li><a href="#tab32" data-bs-toggle="tab">Tab 4</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="panel-body tabs-menu-body">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Secondary Tabs style</h3>
                                </div>
                                <div class="card-body">
                                    <div class="panel panel-primary">
                                        <div class="tab-menu-heading">
                                        ...
                                        <div class="tab-menu-heading">
                                            <div class="tabs-menu">
                                                ...
                                                <ul class="nav panel-tabs panel-danger">
                                                    <li><a href="#tab13" class="active" data-bs-toggle="tab"><span><i class="fe fe-user me-1"></i></span>Tab 1</a></li>
                                                    <li><a href="#tab14" data-bs-toggle="tab"><span><i class="fe fe-calendar me-1"></i></span>Tab 2</a></li>
                                                    <li><a href="#tab15" data-bs-toggle="tab"><span><i class="fe fe-settings me-1"></i></span>Tab 3</a></li>
                                                    <li><a href="#tab16" data-bs-toggle="tab"><span><i class="fe fe-bell me-1"></i></span>Tab 4</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="panel-body tabs-menu-body">
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Success Tabs style</h3>
                                </div>
                                <div class="card-body">
                                    <div class="panel panel-primary">
                                        <div class="tab-menu-heading">
                                            <div class="tabs-menu">
                                                ...
                                                <ul class="nav panel-tabs panel-success">
                                                    <li><a href="#tab17" class="active" data-bs-toggle="tab"><span><i class="fe fe-user me-1"></i></span>Tab 1</a></li>
                                                    <li><a href="#tab18" data-bs-toggle="tab"><span><i class="fe fe-calendar me-1"></i></span>Tab 2</a></li>
                                                    <li><a href="#tab19" data-bs-toggle="tab"><span><i class="fe fe-settings me-1"></i></span>Tab 3</a></li>
                                                    <li><a href="#tab20" data-bs-toggle="tab"><span><i class="fe fe-bell me-1"></i></span>Tab 4</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="panel-body tabs-menu-body">
                                        ...
                                        <div class="tab-menu-heading">
                                            <div class="tabs-menu">
                                                ...
                                                <ul class="nav panel-tabs panel-info">
                                                    <li><a href="#tab21" class="active" data-bs-toggle="tab"><span><i class="fe fe-user me-1"></i></span>Tab 1</a></li>
                                                    <li><a href="#tab22" data-bs-toggle="tab"><span><i class="fe fe-calendar me-1"></i></span>Tab 2</a></li>
                                                    <li><a href="#tab23" data-bs-toggle="tab"><span><i class="fe fe-settings me-1"></i></span>Tab 3</a></li>
