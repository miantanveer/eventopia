...
@endsection
@section('content')
    <div class="container-login100 my-bg" >
        <div class="wrap-login100 p-6">
            <div class="text-center p-5">
                <img src="{{asset("assets/images/brand/logo13.png")}}" alt="" class="header-brand-img">
            </div>
            <form method="POST" id="verify_form" class="login100-form validate-form mt-5" action="{{route('admin.verify.code')}}" data-parsley-validate>
                @csrf
                <h4>Verification Code</h4>
                <p style="font-size: 12px;" class="text-muted">We send you on email.</p>
                <p style="font-size: 13px;" class="mt-5" >We have send you code on {{ $email }}</p>
            ...
            <br>
            <form id="resend-otp-form" action="{{route('admin.resend.otp')}}" method="post" >
            <div class="container-login100-form-btn">
                    @csrf
                    <input type="hidden" name="email" value="{{ $email}}">
