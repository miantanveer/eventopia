    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
                <div class="card mt-3">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mt-2 row">
                            <div class="col-6">
                                <h3 class="d-inline-block mb-2">{{lang($previousSpaceBookings)}}</h3>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
                <div class="card mt-3">
                    <div class="card-header pb-0 border-bottom-0">
                        <h3 class="number-font">{{ lang('Services') }}</h3>
                        <div class="card-options">
                    ...
                    <table class="table border text-nowrap text-md-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $totalBooking->discount }}</td>
                                <td>{{ $totalBooking->amount }}</td>
                                <td>{{ $totalBooking->status == 1 ? lang('Upcoming') : ($totalBooking->status == 3 ?
                                    lang('Cancel') : lang('Previous')) }}
                                </td>
                            </tr>
        ...
        <div class="row">
                ...
                {{-- <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3"> --}}
                    <div class="card bg-white img-card">
                        ...
                        <div class="col-12 mt-5 text-center">
                            <div class="mb-3">
                                <a href="{{ route('bookings', ['type' => 'active']) }}"
            ...
            <div class="col-12">
                <div class="card bg-white img-card">
                    ...
                    <div class="col-12 mt-5 text-center">
                        <div class="mb-3">
                            <a href="{{ route('bookings', ['type' => 'cancel']) }}"
                                class="btn btn-primary text-white">{{ lang('View Details') }}</a>
                        </div>
                    </div>
                </div>
