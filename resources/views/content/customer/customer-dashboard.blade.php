                                    ...
                                    @forelse ($totalBookings as $totalBooking)
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $totalBooking->status == 1 ? lang('Pending') : ($totalBooking->status == 2 ? lang('Accepted') : ($totalBooking->status == 3 ? lang('Cancelled') : ($totalBooking->status == 4 ? lang('Completed') : lang('Active')))) }}
                                                </td>
                                            </tr>
