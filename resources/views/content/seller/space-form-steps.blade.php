                        ...
                        <div>
                            ...
                            <div id="step-3" class="">
                                ...
                                <div class="innersteps 3 mt-3 mb-3">
                                    ...
                                    <input style="width:144px;height:42px;" type="number" value="500"><input
                                        style="width:81px;height:42px;margin-right:1px;" type="text" value="sq ft">
                                    <br>
                                    <hr class="style1"><br>
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                aria-labelledby="select2-star-time-u5-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-u5-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-29-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-29-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-4c-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-4c-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-e5-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-e5-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-pb-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-pb-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-h6-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-h6-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-tx-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-tx-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-wi-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-wi-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-cr-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-cr-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-bs-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-bs-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-de-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-de-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-a0-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-a0-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-j9-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-j9-container"
                                                                                    title="Start
                                                            Time
                                                        ">Start
                                                                                    Time
                                                                    ...
                                                                    <select name="star-time"
                                                                        ...
                                                                        dir="ltr" style="width: 100%;"><span
                                                                            class="selection"><span
                                                                                ...
                                                                                role="combobox" aria-haspopup="true"
                                                                                aria-expanded="false" tabindex="-1"
                                                                                aria-labelledby="select2-star-time-f0-container"><span
                                                                                    class="select2-selection__rendered"
                                                                                    id="select2-star-time-f0-container"
                                                                                    title="End
                                                            Time
                                                        ">End
                                                                                    Time
                            ...
                            <div id="step-6" class="">
                                ...
                                <div class="row">
                                    <div style="color:#434343;" class="span12 pagination-centered">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" value=""><b>High touch surfaces and
                                                    shared amenities have been disinfected</b>
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                ...
                                <div class="row">
                                    <div style="color:#434343;" class="span12 pagination-centered">
                                        ...
                                        <div class="checkbox">
                                            <label><input type="checkbox" value=""><b>Space has been reconfigured
                                                    to allow for physical distance</b>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div style="color:#434343;" class="span12 pagination-centered">
                                        <div class="checkbox">
                                            <label><input type="checkbox" value=""><b>Detailed checklist of
                                                    updated cleaning procedure. Download checklist</b>
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <label class=" flex-basis-20-sm flex-basis-100 " for="flexible">
                                                    <input type="radio" class="" name="btn"
                                                        id="flexible" value="" cheaked>
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            id="exampleInputname" placeholder="john" required
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"
                                                            id="exampleInputname1" placeholder="Smith" required
