                    ...
                    <div>
                        ...
                        <div id="step-2">
                            <div style="text-align:center;">
                                ...
                                <p><b>Enter the type of space that most closely represents the physical space being listed.
                                        Learn more</b></p>
                            </div>
                            <p> <img src="{{ asset('assets/images/users/spaces/6700.png') }}" alt="img"><b>Examples: 'Apartment' 'Photo Studio' 'Restaurant'</b></p>
                            ...
                            <div class="inner-steps2 mt-2 mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <p><b>Are there parking options at or near your space?</b>
                                        ...
                                        <input style="margin-left:32rem;" class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked3" checked onchange="toggleOptions()">
                                    </p>
                                </div>
                            ...
                            <form id="options">
                                <div>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" value="option 1"><span style="color:#434343"><b>Free onsite parking</b></span>
                                    </label>
                                    <label class="checkbox-inline">
                                        <input style="margin-left:10rem;" type="checkbox" value="option 2"><span style="color:#434343"><b>Paid onsite parking</b></span>
                                    </label>
                                    <label class="checkbox-inline">
                                        <input style="margin-left:10rem;" type="checkbox" value="option 3"><span style="color:#434343"><b>Free street parking</b></span>
                                    </label>
                                </div>
                                <div>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" value="option 4"><span style="color:#434343"><b>Valet</b></span>
                                    </label>
                                    <label class="checkbox-inline">
                                        <input style="margin-left:15.5rem;" type="checkbox" value="option 5"><span style="color:#434343"><b>Metered street parking</b></span>
                                    </label>
                                    <label class="checkbox-inline">
                                        <input style="margin-left:8.6rem;" type="checkbox" value="option 6"><span style="color:#434343"><b>Nearby parking lot</b></span>
                                    </label>
                                </div>
                            </form>
                            <h1 class="mt-4"><strong>Write a description of the parking options</strong></h1>
                            <p> <img src="{{ asset('assets/images/users/spaces/6700.png') }}" alt="img">Don’t include private information. This will be shown publicly.</p>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="w-50 float-end">
                                            <div class="form-check form-switch float-end">
                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked2" checked onchange="toggleTextArea()">
                                            </div>
                                        </div><br>
                                        ...
                                        <div id="textAreaDiv" class="mt-5">
                                            ...
                                            <textarea name="" id="" cols="30" rows="5" class="form-control w-100 p-5" placeholder="Add description"></textarea>
                        ...
                        <div id="step-3" class="">
                            <div style="text-align:center;" class="">
                                ...
                                <p>Create a title that will grab a guest’s interest and describes your space. Do not include your business’s name.</p>
                            </div>
                            <div class="innersteps 3 mt-3 mb-3">
                                <h4>Try to include the following:</h4>
                                <ul style="list-style-type:disc;color:#434343">
                                    <li><b><span style="color:black;">Location</span></b> - urban, downtown, marina</li>
                                    <li><b><span style="color:black;">The type of space</span></b> - loft, studio, dance hall, penthouse</li>
                                    <li><b><span style="color:black;">Unique adjective</span></b> - industrial, rustic, roomy</li>
                                </ul>
                                <p> <img src="{{ asset('assets/images/users/spaces/6700.png') }}" alt="img"><b>Example: “Downtown Loft with Skyline View”</b></p>
                                <input type="text" class="form-control rounded-0" id="inputtext" placeholder="Enter your space title">
                                <br>
                                <hr class="style1"><br>
                                <h1><strong>Describe the parking options</strong></h1>
                                <p style="color:black;"><b>Include details about your space so that guests will know everything it offers.</b></p>
                                <h1 style="font-size:20px;color:black;" class="mt-3">Try to answer questions like:</h1>
                                <ul style="list-style-type:disc;color:#434343">
                                ...
                                <p><b>Contact information</b> - Do not include your phone number, venue name, address, email, or links to your website.</p>
                                <label class="form-check-label" for="flexSwitchCheckChecked"></label>
                                ...
                                <ul style="list-style-type:disc">
                                    <li><b><span style="color:black;">Cleaning Fee</span></b> - Basic cleaning is the responsibility of the host. If you charge a cleaning fee, you can add it in a later section.</li>
                                    <li><b><span style="color:black;">Contracts </span></b> - Peerspace bookings are covered by our Service Agreement. Do not paste your contract, cancellation policy, or
                                        liability policy.</li>
                                </ul>
                                <label class="form-check-label" for="flexSwitchCheckChecked"></label>
                                ...
                                <input type="text" class="form-control rounded-0" id="inputtext" placeholder="Optional - example: Name  Eventopia Password: 12345678"><br>
                                <p> <img src="{{ asset('assets/images/users/spaces/lock.png') }}" alt="img"><b> Don't worry, we'll only share this with guests after you have accepted their booking.</b></p>
                                <br>
                                <hr class="style1"><br>
                                ...
                                <p>Directions to your space, building access, door buzzers, floors, stairs/elevator access etc.</p><br>
                                <label class="form-check-label" for="flexSwitchCheckChecked"></label>
                                <textarea style="height:150px;" class="form-control rounded-0" id="exampleFormControlTextarea1" rows="3">Add description</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-6 col-sm-6 mt-2">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <select name="star-time" class="form-control form-select select2 select2-hidden-accessible" data-bs-placeholder="Select Country" tabindex="-1" aria-hidden="true">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default select2-container--below" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-u5-container"><span class="select2-selection__rendered" id="select2-star-time-u5-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-29-container"><span class="select2-selection__rendered" id="select2-star-time-29-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-4c-container"><span class="select2-selection__rendered" id="select2-star-time-4c-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-e5-container"><span class="select2-selection__rendered" id="select2-star-time-e5-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-pb-container"><span class="select2-selection__rendered" id="select2-star-time-pb-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-h6-container"><span class="select2-selection__rendered" id="select2-star-time-h6-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-tx-container"><span class="select2-selection__rendered" id="select2-star-time-tx-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-wi-container"><span class="select2-selection__rendered" id="select2-star-time-wi-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-cr-container"><span class="select2-selection__rendered" id="select2-star-time-cr-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-bs-container"><span class="select2-selection__rendered" id="select2-star-time-bs-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="example-radios6" value="option1" checked="">
                                                                <span class="custom-control-label">6:00 AM - 12:00 AM</span>
                                                            </label>
                                                            <label class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="example-radios6" value="option2">
                                                                <span class="custom-control-label">Set hours</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-de-container"><span class="select2-selection__rendered" id="select2-star-time-de-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-a0-container"><span class="select2-selection__rendered" id="select2-star-time-a0-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="custom-controls-stacked">
                                                            <label class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="example-radios7" value="option1" checked="">
                                                                <span class="custom-control-label">6:00 AM - 12:00 AM</span>
                                                            </label>
                                                            <label class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="example-radios7" value="option2">
                                                                <span class="custom-control-label">Set hours</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-j9-container"><span class="select2-selection__rendered" id="select2-star-time-j9-container" title="Start
                                                            Time
                                                        ">Start
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                </select><span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-star-time-f0-container"><span class="select2-selection__rendered" id="select2-star-time-f0-container" title="End
                                                            Time
                                                        ">End
                                                                                Time
                                                                            </span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        ...
                        <div id="step-6" class="">
                            <div style="text-align:center;">
                                ...
                                <p>Fill out the form to add your cleaning protocol and additional health and safety measures to your listing page.</p>
                            </div>
                            <h4><img src="{{ asset('assets/images/users/spaces/Group 8022.png') }}" alt="img">
                                <b>Enhanced Health and Safety Measures</b>
                            </h4>
                            <p>Select at least 1 from each category below to earn the Enhanced Health and Safety Measures badge. This badge will be displayed
                                on your listings.</p>
                            <br>
                            <hr class="style1"><br>
                            ...
                            <div class="row">
                                <div style="color:#434343;" class="span12 pagination-centered">
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>The space is cleaned and disinfected in accordance with guidelines from local health authorities</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>High touch surfaces and shared amenities have been disinfected</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Soft, porous materials have been properly cleaned or removed</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>A licensed professional cleaner is hired between bookings</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Bookings are spaced apart to allow for enhanced cleaning</b></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div style="color:#434343;" class="span12 pagination-centered">
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Disinfecting wipes or spray and paper towels</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                    ...
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Disposable masks / face coverings</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                            ...
                            <h3 class=" mt-4">What have you done to help guests maintain physical distance in your space?</h3>
                            <p style="color:#858585;"><strong>Select all that apply</strong></p>
                            <div class="row">
                                <div style="color:#434343;" class="span12 pagination-centered">
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Capacity is limited based on governmental guidelines</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Space has access to outdoor air ventilation</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Space has HEPA-certified air filters</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Space has additional space outdoors</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Space has been reconfigured to allow for physical distance</b>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div style="color:#434343;" class="span12 pagination-centered">
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Detailed checklist of updated cleaning procedure. Download checklist</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>COVID-19 guest guidelines print outs. Download guidelines</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Common areas have 6-foot (2-metre) markers on floors</b>
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" value=""><b>Narrow passages have arrows for bi-directional traffic</b>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="step-5" class="mb-5">
                                <div class="container">
                                    <div class="text-center mb-6">
                                        ...
                                        <p class=""><img src="{{ asset('assets/images/brand/light-bulb.png') }}" class="w-5" alt=""> Hosts with more flexible cancellation policies attract more
                                            bookings.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <label class=" flex-basis-20-sm flex-basis-100" for="very-flexible">
                                                <input type="radio" class="" id="very-flexible" name="btn" value="">
                                        ...
                                        <div class="col-3">
                                            <label class=" flex-basis-20-sm flex-basis-100 " for="flexible">
                                                <input type="radio" class="" name="btn" id="flexible" value="" cheaked>
                        ...
                        <div id="step-8" class="mb-5">
                            <div style="text-align:center">
                                ...
                                <p> <img src="{{ asset('assets/images/users/spaces/6700.png') }}" alt="img"><b>Tip: To be approved for Meetings your photos must display a meeting or workshop setup including tables and chairs. We also
                                            ...
                                            <div class="panel panel-default active">
                                                <div class="panel-heading back-g-color" role="tab" id="headingOne1">
                                                    ...
                                                    <h4 class="panel-title bg-primary text-center">
                                                        <a role="button" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapse1" class="text-white" aria-expanded="true" aria-controls="collapse1"> Enable </a>
                                                    </h4>
                                                </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group mb-6">
                                                            <div class="input-group w-100">
                                                                <input type="text" class="form-control" placeholder="80" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <div class="input-group w-100">
                                                                <input type="text" class="form-control" placeholder="5" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                                <span class="input-group-text" id="basic-addon2"><i class="fa fa-calendar w-5 text-white"></i></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            <div class="input-group w-100">
                                                                <input type="text" class="form-control" placeholder="Optional" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            <div class="input-group w-100">
                                                                <input type="text" class="form-control" placeholder="250" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                                <span class="input-group-text" id="basic-addon2"><i class="fa fa-group w-5 text-white"></i></span>
                                                            </div>
                                                        </div>
                                                        <label class="form-label">Who can book instantly?</label>
                                                        <hr class="bg-dark mb-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="span12 pagination-centered">
                                                                ...
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Tables</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Chairs</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Whiteboard</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Chalkboard</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Projector</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Screen</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Flip Charts</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Monitor</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Conference Phone</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Parking Space(s)</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Public Transportation</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Restrooms</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Wheelchair Accessible</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Breakout Space</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Kitchen</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Coffee</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Apple TV</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Printer</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Rooftop</label>
                                                                </div>
                                                                <div class="checkbox">
                                                                    <label><input type="checkbox" value="">Outdoor Area</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="mt-4">
                                                            <h4>Add your own amenities</h4>
                                                            <input style="width:195px;height:42px;" type="text" class="btn btn-default rounded-0">
                                                            <button style="margin-left:20px;width:80px;height:42px;background-color:#00224F;color:white;" type="button" class="btn btn-default rounded-0">Add</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                            <div class="panel panel-default active">
                                                <div class="panel-heading back-g-color" role="tab" id="headingOne1">
                                                    ...
                                                    <hr class="bg-dark mb-0 mt-1">
                                                    <h4 class="panel-title bg-primary text-center">
                                                        <a role="button" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapse2" class="text-white" aria-expanded="true" aria-controls="collapse1"> Enable </a>
                                                    </h4>
                                                </div>
                                        ...
                                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                            <div class="panel panel-default active">
                                                <div class="panel-heading back-g-color" role="tab" id="headingOne1">
                                                    ...
                                                    <hr class="bg-dark mb-0 mt-1">
                                                    <h4 class="panel-title bg-primary text-center">
                                                        <a role="button" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapse3" class="text-white" aria-expanded="true" aria-controls="collapse1"> Enable </a>
                                                    </h4>
                                                </div>
                                                <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne1">
                                                    <div class="panel-body">
                                                        <label class="form-label">Pricing</label>
                                                        <hr class="bg-dark mt-0">
                                                        <label class="mb-5">Hourly rate</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="text-center chat-image mb-5">
                                            <div class="avatar avatar-xxl chat-profile mb-3 brround" id="uploadContainer">
                                                <a class="" href="#">
                                                    <img alt="avatar" src="{{ asset('assets/images/users/23.jpeg') }}" class="avatar avatar-xxl chat-profile mb-3 brround" id="avatarImage">
                                                </a>
                                            </div>
                                            <div class="text-center">
                                                <button type="button" class="bg-primary text-white p-3 border-0 text-center">Upload
                                                    photo</button>
                                            </div>
                                        ...
                                        <div class="px-8">
                                            <div class="card">
                                                <div class="card-body">
                                                    <ul>
                                                        <li><img src="{{ asset('assets/images/brand/light-bulb.png')}}" class="w-4" alt=""> No photos of the space</li>
                                                        <li><img src="{{ asset('assets/images/brand/light-bulb.png')}}" class="w-4" alt=""> No business logos</li>
                                                        <li><img src="{{ asset('assets/images/brand/light-bulb.png')}}" class="w-4" alt=""> No group photos</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-5" required>
                                                        <label class="form-check-label" for="invalidCheck-5">Billboard</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-6" required>
                                                        <label class="form-check-label" for="invalidCheck-6">Billboard</label>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-7" required>
                                                        <label class="form-check-label" for="invalidCheck-7">Online
                                                            ad</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-8" required>
                                                        <label class="form-check-label" for="invalidCheck-8">Social
                                                            media</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-9" required>
                                                        <label class="form-check-label" for="invalidCheck-9">Referral
                                                            from
                                                            a Eventopia host</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-10" required>
                                                        <label class="form-check-label" for="invalidCheck-10">Online
                                                            search</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-11" required>
                                                        <label class="form-check-label" for="invalidCheck-11">Attended
                                                            an
                                                            event in a Peerspace</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="" id="invalidCheck-12" required>
                                                        <label class="form-check-label" for="invalidCheck-12">Other</label>
                                                    </div>
                                                </div>
                                                <hr class="bg-dark my-6">
                                            </div>
