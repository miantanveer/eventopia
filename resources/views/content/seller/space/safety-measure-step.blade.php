                            ...
                            <div id="step-6" class="">
                                <form class="validation" method="POST"
                                    ...
                                    @for ($section = 1; $section <= 4; $section++)
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input name="safety_measure[]" required
                                                                data-parsley-errors-container="#sf_error"
                                                                class="safety_measure" type="checkbox"
                                                                value="{{ $safety_measures[$counter]->id }}"
                                                                {{ in_array($safety_measures[$counter]->id, $selectedSafetyMeasureIds) ? 'checked' : '' }}>
                                                            <span
                                                                style="color:#434343"><b>{{ lang($safety_measures[$counter]->safety_measure_options) }}</b></span>
                                                        </label>
                                                    </div>
                                                    @php
                                        ...
                                        @elseif ($section == 3)
                                            <h3 class=" mt-4">
                                                {{ lang('What signage have you added to keep your guests informed?') }}
                                            </h3>
                                            <p style="color:#858585;"><strong>{{ lang('Select all that apply') }}</strong>
                                            </p>
                                        @endif
                                    ...
                                    <textarea style="height:150px;" required data-parsley-minlength="50" name="cleaning_process"
                                        class="form-control rounded-0" id="" rows="3">{{ lang(@$space->cleaning_process) ?? '' }}</textarea>
