                                ...
                                <form class="validation" action="{{ route('add-about', $space->id) }}" method="POST">
                                    ...
                                    <div class="innersteps 3 mt-3 mb-3">
                                        ...
                                        <ul style="list-style-type:disc;color:#434343">
                                            <li><b><span
                                                        style="color:black;">{{ lang('Location') }}</span></b>{{ lang(' - urban, downtown,
                                                                                                            marina') }}
                                            </li>
                                            <li><b><span
                                                        style="color:black;">{{ lang('The type of space') }}</span></b>{{ lang(' - loft,
                                                                                                            studio,
                                        ...
                                        <p> <img src="{{ asset('assets/images/users/spaces/6700.png') }}"
                                                alt="img"><b>{{ lang('Example: “Downtown Loft with Skyline View”') }}</b>
                                        </p>
                                        ...
                                        <h1 style="font-size:20px;color:black;" class="mt-3">
                                        ...
                                        <div class="btn-group">
                                            <input type="number" class="btn btn-outline-default rounded-0" min="1"
                                                step="1" name="space_size" required
                                                data-parsley-errors-container="#sq_error"
                                                value="{{ @$space->space_size ?? '' }}">
                                            <button type="button"
                                                class="btn btn-outline-default rounded-0">{{ lang("sq
                                                                                                    m") }}</button>
                                        </div>
                                        <div id="sq_error"></div>
                                        <br>
                                        ...
                                        <p>{{ lang('Include any rules about what your guests can and cannot do in the space.') }}
                                        </p>
                                        ...
                                        <label class="form-check-label" for="flexSwitchCheckChecked"></label>
                                        <textarea style="height:150px;" required name="space_rules" class="form-control rounded-0"
                                            id="exampleFormControlTextarea1" rows="3">{{ lang(@$space->space_rules ?? '') }}</textarea>
                                        <br>
                                        <hr class="style1"><br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" required name="allowed_age" id="sel1">
                                                <option value="all"
                                                    {{ lang(@$space->allowed_age == 'all' ? 'selected' : '') }}>
                                                    {{ lang('All ages') }}
                                                </option>
                                                <option value="0-10 "
                                                    {{ lang(@$space->allowed_age == '0-10' ? 'selected' : '') }}>
                                                    {{ lang('Age ') }} 0 - 10
                                                </option>
                                                <option value="10-20 "
                                                    {{ lang(@$space->allowed_age == '10-20' ? 'selected' : '') }}>
                                                    {{ lang('Age ') }} 10 - 20
                                                </option>
                                                <option value="20-30 "
                                                    {{ lang(@$space->allowed_age == '20-30' ? 'selected' : '') }}>
                                                    {{ lang('Age') }} 20 - 30
                                                </option>
                                                <option value="30-40 "
                                                    {{ lang(@$space->allowed_age == '30-40' ? 'selected' : '') }}>
                                                    {{ lang('Age') }} 30 - 40
                                                </option>
                                                <option value="40-50 "
                                                    {{ lang(@$space->allowed_age == '40-50' ? 'selected' : '') }}>
                                                    {{ lang('Age') }} 40 - 50
                                                </option>
                                                <option value="50+ "
                                                    {{ lang(@$space->allowed_age == '50+' ? 'selected' : '') }}>
                                                    {{ lang('Age') }} 50+
                                                </option>
                                            </select>
                                        </div>
