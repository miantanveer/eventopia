                                    ...
                                    <form action="#">
                                        ...
                                        <div>
                                            <a style="padding-left:180px;padding-right:170px;"
                                                ...
                                                data-bs-target="#my-modal" data-bs-toggle="modal">Get Started</a>
                                        </div>
                                    </form>
                            </div>
                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="text-center chat-image mb-5">
                                                            ...
                                                            <div class="main-chat-msg-name mx-3">
                                                                <a href="{{ url('profile') }}">
                                                                    <h5 class="mb-1 text-dark fw-semibold">Daniel Joe</h5>
                                                                </a>
                                                                <p class="text-muted mt-0 mb-0 pt-0 fs-13">Singing/Songwriter
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="row p-3">
                                                    <div class="card-body">
                                                        <div class="text-center chat-image mb-5">
                                                            ...
                                                            <div class="main-chat-msg-name mx-3">
                                                                <a href="{{ url('profile') }}">
                                                                    <h5 class="mb-1 text-dark fw-semibold">John Smith</h5>
                                                                </a>
                                                ...
                                                <div class="row p-3">
                                                    <div class="card-body">
                                                        <div class="text-center chat-image mb-5">
                                                            ...
                                                            <div class="main-chat-msg-name mx-3">
                                                                <a href="{{ url('profile') }}">
                                                                    <h5 class="mb-1 text-dark fw-semibold">Ryah Wick</h5>
                                                                </a>
