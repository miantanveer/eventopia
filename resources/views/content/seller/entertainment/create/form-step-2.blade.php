                                ...
                                <form action="{{ route('entertainment_form_2', $id) }}" method="post" class="validation">
                                    ...
                                    <div class="container">
                                        <div class="text-center mb-6">
                                            ...
                                            <p class="">{{lang('Create a title that will grab a guest’s interest and describes
                                                your
                                        ...
                                        <div class="mt-6">
                                            ...
                                            <li class="">{{lang('The type of space - loft, studio, dance hall, penthouse')}}</li>
                                            ...
                                            <div class="mt-7">
                                                ...
                                                <p class="my-4">{{lang('Please only include the size of the space that guests can
                                                    use
                                                    during their booking.')}}</p>
                                                <p><img src="{{ asset('assets/images/brand/light-bulb.png') }}"
                                                        class="w-5" alt=""> {{lang('Example: If your space is 2,000 sq m,
                                                    but guests are
                                                    booking a
                                        ...
                                        <div class="">
                                            <p class="display-8"><b>{{lang('What are your entertainment / talent rules?? ')}}</b>
                                                {{lang('(Optional)')}}
                                            </p>
                                            <p class="my-6">{{lang('Include any rules about what your guests can and cannot do in
                                                the
                                                event.')}}</p>
                                        ...
                                        <div class="mt-7">
                                            <p class="display-8"><b>{{lang('Who’s allowed to watch your entertainment / talent?')}}</b>
                                            </p>
                                        ...
                                        <div class="mt-7">
                                            <p class="display-8"><b>{{lang('Provide arrival instructions')}} </b> {{lang('(Optional)')}}</p>
                                            <p class="my-5">{{lang('Help your guests and their attendees find and enter your
                                                event.')}}
                                            </p>
                                            <h4><b>{{lang('Try to include:')}}</b></h4>
                                            <li class="mb-5">{{lang('Directions to your space, building access, door buzzers,
                                                floors,
                                            ...
                                            <p><i class="fa fa-lock"></i>&nbsp; {{lang("Don't worry, we'll only share this with
                                                guests
