                        ...
                        <div class="col-5">
                            <div class="input-group">
                                <div class="input-group">
                                    ...
                                    <input type="date" name="start_time" class="form-control date" id="date-input">  
                                   </div>
                            </div>
                        </div>
                        <div class="col-2 text-center end">
                            <h6 class="mt-3">To</h6>
                        </div>
                        ...
                        <div class="col-5 end" >
                            <div class="input-group">
                                <div class="input-group">
                                    ...
                                    <input type="date" name="end_time" class="form-control" id="date-input-end" >
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3 mt-3 text-start">
                            <label class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="all_day" id="check">
...
<script>
// This toggles the visibility of the "end" element.
...
$("#date-input").on('input',function() {
    var date = $(this).val(); 
    document.getElementById('date-input-end').min=date;
    
});
const currentDate1 = new Date().toISOString().split('T')[0];
const date = document.getElementById('date-input');
date.min = currentDate1;
</script>
@endsection