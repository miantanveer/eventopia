                                    ...
                                    <div class="card-body p-0">
                                        <div class="row">
                                            <div class="col-12 col-sm-4 col-lg-6">
                                                <h5 class="card-title mt-3">{{ lang($space_remaining->space_title) }}
                                                </h5>
                                            </div>
                            ...
                            <div class="row g-0">
                                <div class="col-md-4 pe-3 pe-lg-0">
                                    <img src="{{ asset(@$space->spaceImages[0]->image) ?? asset('assets/images/no-image-icon-15.png') }}"
                                        class="card-img-left h-100 image_lg" width="200px" height="auto" alt="img">
                                </div>
                                    ...
                                    <div class="card shadow-sm border">
                                        <div class="card-body p-0 p-sm-5">
                                            <div class="row align-items-center">
                                                ...
                                                @if (!$editButtonShown && $spaceHaveActivity->activities->id ==
                                                $space_acitiviy->id)
                                                @php
