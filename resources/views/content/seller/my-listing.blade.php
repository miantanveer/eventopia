                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-sm-4 col-lg-3 mt-5 mt-sm-0">
                                                                    <div class="text-end">
                                                                        ...
                                                                        <a class="modal-effect btn"
                                                                            data-bs-effect="effect-scale"
                                                                            onclick="deleteModal('{{ route('space-delete', $space_remaining->id) }}')">
                                                                            <i
                                                                                class="fa fs-16 fa-trash text-danger"></i></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12 p-2">
                                                        <div class="row">
                                                            <div class="col-12 col-sm-4 col-lg-6 m-auto">
                                                                <h5 class="card-title mt-3 d-inline">
                                                                    {{ lang($data->title) }}
                                                                </h5>
                                                            </div>
                                                            <div class="col-12 col-sm-4 col-lg-3">
                                                ...
                                                <div class="card-body p-0 p-sm-5">
                                                    <div class="mx-0 row w-100 align-items-center">
                                                        ...
                                                        <div class="col-sm-6 col-12 col-lg-8 pe-0">
                                                            ...
                                                            <div class="">
                                                                <span
                                                                    class="tag tag-rounded tag-icon {{ @$space->status == '0' ? 'tag-info' : (@$space->status == '1' ? 'tag-green' : 'tag-red') }}">{{ @$space->status == '0' ? 'Review' : (@$space->status == '1' ? 'Active' : 'Rejected') }}<a
                                                        ...
                                                        <div class="col-sm-6 col-12 col-lg-4 my-auto ps-0 mt-3 mt-sm-0">
                                                            <div class="text-end">
                                                                ...
                                                                <div class="btn-group mt-2 mb-2">
                                                                    <button type="button"
                                                                        class="btn border rounded-1 p-2"
                                            ...
                                            <div class="row g-0">
                                                <div class="col-md-4 pe-3 pe-lg-0">
                                                    <img src="{{ s3Link(@$data->serviceImages[0]->image) }}"
                                                        class="card-img-left h-100 image_lg" width="100%"
                                                        height="auto" alt="img">
                                                </div>
                                                <div class="col-md-8 ps-3 ps-md-0 pe-0 pe-lg-2">
                                                    <div class="card-body p-0 p-sm-5">
                                                        <div class="mx-0 row w-100 align-items-center">
                                                            ...
                                                            <div class="col-sm-6 col-12 col-lg-8 pe-0">
                                                                ...
                                                                <div class="">
                                                                    <span
                                                                        class="tag tag-rounded tag-icon {{ @$data->status == '0' ? 'tag-info' : (@$data->status == '1' ? 'tag-green' : 'tag-red') }}">{{ @$data->status == '0' ? 'Review' : (@$data->status == '1' ? 'Active' : 'Rejected') }}<a
                                                                            class="tag-addon {{ @$data->status == '0' ? 'tag-info' : (@$data->status == '1' ? 'tag-green' : 'tag-red') }}"></a></span>
                                                                </div>
                                                            </div>
                                                            <div
                                                                class="col-sm-6 col-12 col-lg-4 my-auto ps-0 mt-3 mt-sm-0">
                                                                <div class="text-end">
                                                            ...
                                                            <div class="card-body p-0 p-sm-5">
                                                                <div class="row align-items-center">
                                                                    <div
                                                                        class="col-12 col-sm-1 col-lg-1 pt-3 ps-5 pt-sm-0 ps-sm-3">
                                                                        <span><img
                                                                                class="customize_img justify-content-start"
                                                                                style="max-width: 65px !important"
