                                ...
                                <table id="example2"
                                    ...
                                    <thead class="table_head_row">
                                        <tr role="row" class="text-center">
                                            ...
                                            {{-- <th class="sorting text-white p-4" tabindex="0" aria-controls="example2"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending">{{ lang('View') }}
                                            </th> --}}
                                            <th class="sorting text-white p-4" tabindex="0" aria-controls="example2"
                                                rowspan="1" colspan="1"
                                                aria-label="Salary: activate to sort column ascending">{{ lang('Action') }}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if (isset($quotes))
                                            @forelse (@$quotes as $quote)
                                                <tr class="text-center">
                                                    ...
                                                    {{-- <td><a class="modal-effect btn d-grid"
                                                            data-bs-effect="effect-rotate-left" data-bs-toggle="modal"
                                                            href="#bookingDetailModal"><i class="fa fa-eye text-primary"
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        @elseif (@$quote->status == 1)
                                                            <span disabled
                                                                class="badge bg-info-gradient badge-sm me-1 mb-1 mt-1">{{ lang('Quote In Review') }}</span>
                                                        @else
