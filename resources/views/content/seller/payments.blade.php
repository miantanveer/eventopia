                            ...
                            <div class=" tab-menu-heading">
                                <div class="tabs-menu1">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li><a href="#tab5" class="active" data-bs-toggle="tab">{{lang('Payouts')}}</a></li>
                                        <li><a href="#tab6" data-bs-toggle="tab" class="">{{lang('Payment methods')}}</a>
                                        </li>
                                        <li><a href="#tab7" data-bs-toggle="tab" class="">{{lang('Taxes')}}</a></li>
                                        <li><a href="#tab8" data-bs-toggle="tab" class="">{{lang('Accounts')}}</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab5">
                                        <div class="card" id="modal3">
                                            <div class="card-body text-center border p-4 pb-5">
                                                <p class="mb-4 mt-4 mx-4">{{lang('There are no payouts to
                                                    show yet')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="tab6">
                                        <div class="card" id="modal3">
                                            ...
                                            <div class="card-body border p-4 pb-5">
                                                <div class="row">
                                                    <div class="col-9">
                                                        <p class="my-3 mx-4">{{lang('Add a bank account so you can
                                        ...
                                        <div class="card" id="modal3">
                                            ...
                                            <div class="card-body border p-4 pb-5">
                                                <p class="mb-4 mx-4">{{lang('Adding a credit card allows
                                                                    ...
                                                                    <div class="col-md-7 col-12">
                                                                        <form action="">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="form-group">
                                                                                        <label class="form-label">{{lang('CVV')}}
                                        ...
                                        <div class="card" id="modal3">
                                            ...
                                            <div class="card-body border p-4 pb-5">
                                                <p class="mb-4 mx-4">{{lang('Used when processing payouts
                                                    and payments.')}}</p>
                                                <div class="">
                                                    <div class="">
                                                        <div class="">
                                    ...
                                    <div class="tab-pane" id="tab7">
                                        <div class="tab-pane active">
                                            <div class="card" id="modal3">
                                                <div class="card-body text-center border p-4 pb-5">
                                                    <p class="mb-4 mt-4 mx-4">{{lang('There is no tax
                                    ...
                                    <div class="tab-pane" id="tab8">
                                        <div class="tab-pane active">
                                            <div class="card" id="modal3">
                                                ...
                                                @empty
                                                <div class="card-body text-center border p-4 pb-5">
                                                    <p class="mb-4 mt-4 mx-4">{{lang('There is no Account
                                                        information at this time.')}}</p>
                                                </div>
                                                @endforelse
                                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row d-flex justify-content-between flex-wrap">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="bank_name" placeholder="{{lang('Bank Name')}}"
                                    name="bank_name" data-parsley-required-message="{{lang('Bank Name is Required*')}}" required>
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label required" class="control-label">{{lang('Country Of Bank')}}</label>
                                <select style="width:100%;" class="form-select beautyselect"
                                    data-parsley-required-message="{{lang('Country of Bank is Required*')}}" name="country_id"
                                    required id="country">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="bank_number" placeholder="{{lang('Account Number')}}"
                                    name="account_number" data-parsley-required-message="{{lang('Account Number is Required*')}}"
                                    required>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="swift_code" placeholder="{{lang('Swift Code')}}"
                                    name="swift_code" data-parsley-required-message="{{lang('Swift Code is Required*')}}" required>
                                <span id="Address_err" class="text-danger">
                                    @error('location')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="bank_address" placeholder="{{lang('Bank Address')}}"
                                    name="bank_address" data-parsley-required-message="{{lang('Bank Address is Required*')}}"
                                    required>
                                <span id="Address_err" class="text-danger">
                                    @error('location')
                                        {{ $message }}
                            ...
                            <div class="mb-3 col-md-6">
                                <label class="form-label" class="control-label">{{lang('Account Holder
                                    Name')}}</label>
                            ...
                            <div class="mb-3 col-md-6">
                                <div class="form-group">
                                    <label for="account_type" class="form-label" class="control-label">{{lang('Select Account
                                        Type')}}</label>
