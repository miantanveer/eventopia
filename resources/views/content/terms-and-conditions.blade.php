...
<p>Welcome to Eventopia!</p>

<p>These terms and conditions outline the rules and regulations for the use of Eventopia's Website, located at
    eventopia4u.com.</p>

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Eventopia if you do
...
<p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
    ...
    accordance with and subject to, prevailing law of sa. Any use of the above terminology or other words in the
    singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to
    same.</p>

<h3><strong>Cookies</strong></h3>

<p>We employ the use of cookies. By accessing Eventopia, you agreed to use cookies in agreement with the Eventopia's
    Privacy Policy. </p>
...
<p>Unless otherwise stated, Eventopia and/or its licensors own the intellectual property rights for all material on
    Eventopia. All intellectual property rights are reserved. You may access this from Eventopia for your own personal
    use subjected to restrictions set in these terms and conditions.</p>

<p>You must not:</p>
<ul>
    <li>Republish material from Eventopia</li>
    <li>Sell, rent or sub-license material from Eventopia</li>
    <li>Reproduce, duplicate or copy material from Eventopia</li>
    <li>Redistribute content from Eventopia</li>
</ul>
...
<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
    of the website. Eventopia does not filter, edit, publish or review Comments prior to their presence on the website.
    Comments do not reflect the views and opinions of Eventopia,its agents and/or affiliates. Comments reflect the views
    and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Eventopia
...
<p>Eventopia reserves the right to monitor all Comments and to remove any Comments which can be considered
...
<p>You hereby grant Eventopia a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and
...
<p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Eventopia; and (d)
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
    must inform us by sending an e-mail to Eventopia. Please include your name, your organization name, contact
...
<p>No use of Eventopia's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
