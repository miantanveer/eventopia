            ...
            <div class="custom-controls-stacked">
                <form action="#" method="get" class="ms-2">
                    <div class="px-5 pt-5 pb-2">
                        ...
                        <label class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="guests" value="250">
                            <span class="custom-control-label">{{ lang('$100 to $250') }}</span>
                        </label>
                        <label class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="guests" value="450">
                    ...
                    <div class="row mt-2">
                        <div class="w-45 pe-0">
                            <div class="btn-group w-90">
                                ...
                                <input type="text" class="btn btn-outline-default rounded-0" name="guests"
                                    required data-parsley-errors-container="#sq_error" value="" id="guestsFrom">
                            </div>
                        </div>
                        ...
                        <div class="w-45 ps-0">
                            <div class="btn-group w-90">
                                <button type="button"
                                    class="btn btn-outline-default rounded-0 disabled"><b>$</b></button>
                                <input type="text" class="btn btn-outline-default rounded-0" name="guests"
                                    required data-parsley-errors-container="#sq_error" value="" id="guestsTo">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5 mb-1">
                        ...
                        <div class="w-50">
                            <a onclick="selected($('#price').val())"  class="float-end bg-primary py-2 px-5 me-3 text-white"
            ...
            <div class="custom-controls-stacked">
                <form action="#" method="get" class="ms-2">
                    <div class="px-5 pt-5 pb-2">
                        ...
                        <label class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="guests" value="50">
                        ...
                        <label class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="guests" value="500">
                    ...
                    <div class="row mt-2">
                        <div class="w-100 ms-5 pe-0">
                            <div class="w-100">
                                <input type="number" class="btn btn-outline-default rounded-0" id="guests">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-5 mb-1">
                        <div class="w-50">
                            <a onclick="$('#guests').val('')"  class="float-start text-dark p-3">Clear</a>
                        </div>
                        <div class="w-50">
    ...
    <div class="col-xl-1 col-md-2 col-sm-6 col-6 pe-0">
        <form action="#" class="mt-2">
            <input id="dateInput" type="text" class="form-control w-style button-radias btn_background"
                placeholder="When?" onclick="(this.type='date')">
        </form>
    </div>
    ...
    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 d-md-block d-none">
        <form action="#" class="mt-2">
            <input type="text" class="form-control w-style button-radias btn_background"
                id="typeCategories" placeholder="{{ lang('Enter a Keyword') }}">
        </form>
    </div>
