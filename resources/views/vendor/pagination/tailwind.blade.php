@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="row">
        {{-- <div class="flex justify-between flex-1 sm:hidden">
            ...
            <div class="col-6 text-end">
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}" style="border-top-left-radius: 50%; border-bottom-left-radius: 50%;">
