...
class EntertainmentSeeder extends Seeder
{
    ...
    public function run()
    {
        Entertainment::create( [
            ...
            'comedian'=>'Singers',
            'house_rules'=>'Contracts - Peerspace bookings are covered by our Service Agreement. Do not paste your contract, cancellation policy, or liability policy.',
            'recordings'=>'Contracts - Peerspace bookings are covered by our Service Agreement. Do not paste your contract, cancellation policy, or liability policy.',
            'title'=>'Skyline',
            'space'=>'588',
            'age'=>'21+',
            'arrival'=>NULL,
            'cancellation_policy'=>'v_flexible',
