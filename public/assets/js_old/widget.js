                ...
                !(function (t, e) {
                    ...
                    var t = 1,
                        ...
                        d = {
                            ...
                            namespaceEvents: function namespaceEvents(t, e) {
                                return (t = this.trimString(t || "").split(
                                    /\s+/
                                ))[0]
                                    ? h
                                          .map(t, function (t) {
                    ...
                    c.prototype = {
                        validate: function validate(t, e) {
                            ...
                            if (Array.isArray(t)) {
                                ...
                                return this.validateMultiple.apply(
                                    this,
                                    arguments
                                );
                            }
                            ...
                            if (this.validateNumber)
                                return (
                                    ...
                                    (!isNaN(t) &&
                                        ...
                                        this.validateNumber.apply(
                                            this,
                                            arguments
                                        )))
                                );
                            if (this.validateString)
                                return this.validateString.apply(
                                    this,
                                    arguments
                                );
                            throw (
                                ...
                                ? (function (t, e, i) {
                                      ...
                                      for (var s in t) {
                                          if (s) {
                                              var a = i(s);
                                              "string" == typeof a &&
                                                  (a = d.parseRequirement(
                                                      t[s],
                                                      a
                                                  )),
                                                  (n[s] = a);
                                          } else
                                              r = d.parseRequirement(t[s], e);
                                      }
                    ...
                    function m(s, a) {
                        return function (t) {
                            ...
                            return (
                                ...
                                a.apply(
                                    void 0,
                                    [t].concat(u(((n = s), i.map(d.parse[n]))))
                                )
                            );
                            var n;
                        };
                    ...
                    a.prototype = {
                        ...
                        setLocale: function setLocale(t) {
                            if (void 0 === this.catalog[t])
                                throw new Error(
                                    t + " is not available in the catalog"
                                );
                        ...
                        addValidator: function addValidator(t, e, i) {
                            if (this.validators[t])
                                d.warn(
                                    'Validator "' + t + '" is already defined.'
                                );
                        ...
                        validators: {
                            ...
                            euvatin: {
                                validateString: function validateString(t) {
                                    if (!t) return !0;
                                    return /^[A-Z][A-Z][A-Za-z0-9 -]{2,}$/.test(
                                        t
                                    );
                                },
                                priority: 30,
                    ...
                    (v.Form = {
                        ...
                        (v.Field = {
                            ...
                            getErrorsMessages: function getErrorsMessages() {
                                ...
                                for (
                                    var t = [], e = 0;
                                    e < this.validationResult.length;
                                    e++
                                ) {
                                    t.push(
                            ...
                            _manageErrorsMessages:
                                function _manageErrorsMessages(t) {
                                    if (
                                        void 0 ===
                                        this.options.errorsMessagesDisabled
                                    ) {
                                        if (
                                            void 0 !== this.options.errorMessage
                                        )
                                            return t.added.length ||
                                                t.kept.length
                                        ...
                                        for (
                                            ...
                                            this._removeError(
                                                t.removed[e].assert.name
                                            );
                                        }

                                        for (e = 0; e < t.added.length; e++) {
                                            this._addError(
                                                t.added[e].assert.name,
                                                {
                                                    message:
                                                        t.added[e].errorMessage,
                                        ...
                                        for (e = 0; e < t.kept.length; e++) {
                                            this._updateError(
                                                t.kept[e].assert.name,
                                                {
                                                    message:
                                                        t.kept[e].errorMessage,
                            ...
                            _manageClassHandler:
                                function _manageClassHandler() {
                                    if (
                                        "string" ==
                                            typeof this.options.classHandler &&
                            ...
                            _insertErrorWrapper:
                                function _insertErrorWrapper() {
                                    var t = this.options.errorsContainer;
                                    if (
                                        0 !==
                                        this._ui.$errorsWrapper.parent().length
                                    )
                    ...
                    y.prototype = {
                        ...
                        whenValidate: function whenValidate(t) {
                            ...
                            var o = this._withoutReactualizingFormOptions(
                                function () {
                        ...
                        whenValid: function whenValid(t) {
                            ...
                            var s = this._withoutReactualizingFormOptions(
                                function () {
                        ...
                        _withoutReactualizingFormOptions:
                            function _withoutReactualizingFormOptions(t) {
                    ...
                    function b(t, e, i, r, n) {
                        ...
                        l(this, {
                            ...
                            requirements: i,
                            priority: (r =
                                r || t.options[e + "Priority"] || a.priority),
                        ...
                        rejected: !(b.prototype = {
                            ...
                            _parseRequirements: function _parseRequirements(i) {
                                ...
                                this.requirementList =
                                    this.validator.parseRequirements(
                                        this.requirements,
                                        function (t) {
                                            return i[
                                                r.name +
                    ...
                    w.prototype = {
                        ...
                        addConstraint: function addConstraint(t, e, i, r) {
                            if (
                                window.Parsley._validatorRegistry.validators[t]
                            ) {
                                var n = new b(this, t, e, i, r);
                                "undefined" !==
                                    this.constraintsByName[n.name] &&
                        ...
                        updateConstraint: function updateConstraint(t, e, i) {
                            return this.removeConstraint(t).addConstraint(
                                t,
                                e,
                                i
                            );
                        ...
                        _bindHtml5Constraints:
                            function _bindHtml5Constraints() {
                                null !==
                                ...
                                null !== t && null !== e
                                    ...
                                    : null !== e &&
                                      this.addConstraint("max", e, void 0, !0),
                                    null !==
                                        this.element.getAttribute(
                                            "minlength"
                                        ) &&
                        ...
                        _isRequired: function _isRequired() {
                            return (
                                ...
                                !1 !==
                                    this.constraintsByName.required.requirements
                            );
                        },
                        _trigger: function _trigger(t) {
                        ...
                        _getGroupedConstraints:
                            function _getGroupedConstraints() {
                    ...
                    function A(t, e, i) {
                        ...
                        return (
                            (this.parent = i || window.Parsley), this.init(e)
                        );
                    }
                    ...
                    A.prototype = {
                        ...
                        handleMultiple: function handleMultiple() {
                            ...
                            (this.options.multiple =
                                this.options.multiple.replace(
                                    /(:|\.|\[|\]|\{|\}|\$)/g,
                                    ""
                                )),
                                t &&
                                    h('input[name="' + t + '"]').each(function (
                                        t,
                                        e
                                    ) {
                                        var i = d.getType(e);
                            ...
                            for (
                                var i = this._findRelated(), n = 0;
                                n < i.length;
                                n++
                            ) {
                                if (
                                    void 0 !== (e = h(i.get(n)).data("Parsley"))
                                ) {
                        ...
                        bind: function bind(t, e) {
                            ...
                            switch (t) {
                                ...
                                default:
                                    throw new Error(
                                        t + "is not a supported Parsley type"
                                    );
                            }
                    ...
                    return (
                        ...
                        (h.unsubscribeAll = function (e) {
                            V(),
                                ...
                                h("form,input,textarea,select").each(
                                    function () {
                        ...
                        h.extend(!0, x, {
                            ...
                            addAsyncValidator: function addAsyncValidator(
                                t,
                                e,
                                i,
                                r
                        ...
                        x.addValidator("remote", {
                            ...
                            validateString: function validateString(
                                ...
                                -1 <
                                (e = x.asyncValidators[o].url || e).indexOf(
                                    "{value}"
                                )
                                    ? (e = e.replace(
                                          "{value}",
                                ...
                                (n = h.extend(
                                    ...
                                    (s = h.param(n)),
                                    void 0 === x._remoteCache &&
                                        (x._remoteCache = {});

                                function u() {
                                    var t = x.asyncValidators[o].fn.call(
                                        r,
                                        d,
                                        e,
                                        i
                                    ...
                                    return (
                                        (t = t || h.Deferred().reject()),
                                        h.when(t)
                                    );
                                }

                                var d = (x._remoteCache[s] =
                                    x._remoteCache[s] || h.ajax(n));
                                return d.then(u, u);
                            },
                            priority: -1,
                        }),
                        ...
                        new (function () {
                            ...
                            l(this, {
                                isNativeEvent: function isNativeEvent(t) {
                                    return (
                                        t.originalEvent &&
                                        !1 !== t.originalEvent.isTrusted
                                    );
                                },
                                fakeInputEvent: function fakeInputEvent(t) {
                                    r.isNativeEvent(t) &&
                                        h(t.target).trigger("input");
                                },
