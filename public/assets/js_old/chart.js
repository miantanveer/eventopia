  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [(_ref = {
        ...
        borderColor: '#6c5ffc'
      }, _defineProperty(_ref, "borderWidth", 3), _defineProperty(_ref, "pointBackgroundColor", '#ffffff'), _defineProperty(_ref, "pointRadius", 2), _ref), (_ref2 = {
        label: 'Expenses',
        data: [450, 200, 350, 250, 480, 200, 400],
        borderWidth: 2,
        backgroundColor: 'transparent',
        borderColor: '#05c3fb'
      }, _defineProperty(_ref2, "borderWidth", 3), _defineProperty(_ref2, "pointBackgroundColor", '#ffffff'), _defineProperty(_ref2, "pointRadius", 2), _ref2)]
    },
    options: {
      responsive: true,
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [(_ref3 = {
        ...
        borderColor: '#6c5ffc'
      }, _defineProperty(_ref3, "borderWidth", 2.0), _defineProperty(_ref3, "pointBackgroundColor", '#ffffff'), _ref3)]
    },
