    ...
    public function verifyOtp(Request $req)
    {
        ...
        if ($otp == $user->otp) {
            ...
            if ($req->sendFor == 'signup') {
                ...
                return response()->json(['token'=>$user->createToken($user->email)->plainTextToken,'email' => $req->email ?? '', 'phoneNumber' => $req->phoneNumber ?? '', 'success', 'Otp Matched Successfully.'], 200);
